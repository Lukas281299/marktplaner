...
export const BIBLIOTHEK: BibliothekEintrag[] = [
  ...
  { id: 'bakeoff-ecke-frei', name: 'BakeOff-Eckstück frei', kategorie: 'backwaren', breite: 88.5, tiefe: 88.5, hoehe: 185.5, form: 'umriss', farbe: '#c49a6c', polygon: [{ x: -44.25, y: -44.25 }, { x: 44.25, y: -44.25 }, { x: 44.25, y: 44.25 }, { x: -10, y: 44.25 }], hinweis: 'Trapez mit vier Ecken · Ziehen setzt es hin, Doppelklick zeichnet den Umriss selbst – für jeden Winkel, nicht nur 45°', gruppe: 'Ecken und Anbauten' },
