 ...
 * ankommt. Zwei Zahlen nebeneinander, die Verschiedenes messen, sind leicht
 * zu verwechseln; eine leere Spalte, die wie eine Null aussieht, wäre der
 * schlimmste Fall.
 */
...
describe('Meter je Warengruppe', () => {
  ...
  it('zeigt zugeklappt die Summe beider Spalten', async () => {
  ...
  it('zeigt aufgeklappt die Zeile der Warengruppe', async () => {
    render(<Warengruppenmeter projekt={projekt([zug()])} />);
